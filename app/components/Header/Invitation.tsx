        ...
        <div id="home" className="hero min-h-screen">
                <div className="max-w-screen-xl  text-center appear-animation">
                    ...
                    <div className="max-[360px]:flex max-[360px]:flex-col max-[360px]:gap-y-4   min-[361px]:space-x-4">
                        ...
                        <Link href="https://drive.google.com/file/d/12MXzJiiCCHm4rQj5ZahQfbEI28VMjIed/view?usp=sharing" target="_blank" rel="noopener noreferrer"> <button className="shiny bg-neutral btn glass w-40 ">Open PDF Resume<i className={styles.shiny}></i></button></Link>
                    </div>
                    <SocialButton/>
                </div>
        </div>
